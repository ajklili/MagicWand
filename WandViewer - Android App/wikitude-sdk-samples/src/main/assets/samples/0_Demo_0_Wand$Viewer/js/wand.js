...
var ServerInformation = {
	POIDATA_SERVER: "http://54.91.116.127/getpois/",
...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
		    World.markerDrawable_idle = new AR.ImageResource(poiData[currentPlaceNr].imageurl);
			var singlePoi = {
				...
				"image": poiData[currentPlaceNr].imageurl
			};
	...
	*/
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
		...
		var img=document.getElementById('poi-detail-image');
        img.src=marker.poiData.image;
